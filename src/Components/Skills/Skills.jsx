      ...
      <div className="all-skills">
        ...
        <div className="skills-section">
          ...
          <StyledDivForSkills>
            ...
            <span className="html-text">CSS</span>
          </StyledDivForSkills>
          <StyledDivForSkills>
            <DiJavascript1 size={"70px"} className="html-icon" />
            <span className="html-text">JavaScript</span>
          </StyledDivForSkills>
          <StyledDivForSkills>
            <FaReact size={"70px"} className="html-icon" />
            <span className="html-text">React</span>
          </StyledDivForSkills>
          <StyledDivForSkills>
            <SiRedux size={"70px"} className="html-icon" />
            <span className="html-text">Redux</span>
          </StyledDivForSkills>
          <StyledDivForSkills>
            <FaNodeJs size={"70px"} className="html-icon" />
            <span className="html-text">NodeJs</span>
          </StyledDivForSkills>
          <StyledDivForSkills>
            <SiExpress size={"70px"} className="html-icon" />
            <span className="html-text">ExpressJs</span>
          </StyledDivForSkills>
          <StyledDivForSkills>
            <SiMongodb size={"70px"} className="html-icon" />
            <span className="html-text">MongoDB</span>
          </StyledDivForSkills>
        </div>
        <div className="skills-section">
          ...
          <StyledDivForSkills>
            ...
            <span className="html-text">JSON-Server</span>
          </StyledDivForSkills>
          <StyledDivForSkills>
            <SiChakraui size={"70px"} className="html-icon" />
            <span className="html-text">Chakra-UI</span>
          </StyledDivForSkills>
          <StyledDivForSkills>
            <SiMaterialui size={"70px"} className="html-icon" />
            <span className="html-text">Material-UI</span>
          </StyledDivForSkills>
          <StyledDivForSkills>
            <SiStyledcomponents size={"70px"} className="html-icon" />
            <span className="html-text">Styled-Components</span>
          </StyledDivForSkills>
          <StyledDivForSkills>
            <SiBootstrap size={"70px"} className="html-icon" />
            <span className="html-text">Bootstrap</span>
          </StyledDivForSkills>
        </div>
        ...
        <div className="skills-section">
          ...
          <StyledDivForSkills>
            ...
            <span className="html-text">Git</span>
          </StyledDivForSkills>
          <StyledDivForSkills>
            <SiPostman size={"70px"} className="html-icon" />
            <span className="html-text">Postman</span>
          </StyledDivForSkills>
          <StyledDivForSkills>
            <SiNpm size={"70px"} className="html-icon" />
            <span className="html-text">NPM</span>
          </StyledDivForSkills>
          <StyledDivForSkills>
            <SiYarn size={"70px"} className="html-icon" />
            <span className="html-text">Yarn</span>
          </StyledDivForSkills>
          <StyledDivForSkills>
            <SiGithub size={"70px"} className="html-icon" />
            <span className="html-text">GitHub</span>
          </StyledDivForSkills>
          <StyledDivForSkills>
            <SiCanva size={"70px"} className="html-icon" />
            <span className="html-text">Canva</span>
          </StyledDivForSkills>
          <StyledDivForSkills>
            <SiNetlify size={"70px"} className="html-icon" />
            <span className="html-text">Netlify</span>
          </StyledDivForSkills>
          <StyledDivForSkills>
            <SiVercel size={"70px"} className="html-icon" />
            <span className="html-text">Vercel</span>
          </StyledDivForSkills>
          <StyledDivForSkills>
            <SiHeroku size={"70px"} className="html-icon" />
            <span className="html-text">Heroku</span>
          </StyledDivForSkills>
          <StyledDivForSkills>
            <SiReplit size={"70px"} className="html-icon" />
            <span className="html-text">Replit</span>
          </StyledDivForSkills>
          <StyledDivForSkills>
            <SiCodesandbox size={"70px"} className="html-icon" />
            <span className="html-text">Codesandbox</span>
          </StyledDivForSkills>
          <StyledDivForSkills>
            <SiCodepen size={"70px"} className="html-icon" />
            <span className="html-text">Codepen</span>
          </StyledDivForSkills>
          <StyledDivForSkills>
            <SiMiro size={"70px"} className="html-icon" />
            <span className="html-text">Miro</span>
          </StyledDivForSkills>
          <StyledDivForSkills>
            <SiNotion size={"70px"} className="html-icon" />
            <span className="html-text">Notion</span>
          </StyledDivForSkills>
          <StyledDivForSkills>
            <SiMongodb size={"70px"} className="html-icon" />
            <span className="html-text">Atlas</span>
          </StyledDivForSkills>
        </div>
